  ...
  \path[draw=red, line width=2pt, rounded corners=4pt]
    ...
    in
      (\x{mid}, \y{mid})
        ...
        -- (\x{X_1}, \y{X_1})
        -| cycle
      ($(\x{orig_1}, \y{orig_1})!0.5!(\x{X_1}, \y{Y_1})$) node[align=center] {\small Mine data \& Run simulation\\ \small \bfseries 4 GPUs + 28 CPUs}
  ;
  ...
  \path[draw=blue, line width=2pt, rounded corners=5pt]
    ...
    in
      ...
      (\x{mid_compute}, \y{mid_compute}) node [] (compute_begin) {}
        ...
        -| cycle
      ($(\x{orig_0_compute}, \y{orig_0_compute})!0.5!(\x{X_0_compute}, \y{Y_0_compute})$) node[align=center,rotate=90] {\small Run simulation\\ \small \bfseries 4 GPUs + 28 CPUs}
