...
??? info "ULHPC account (login) vs. Slurm [meta-]account"
    - Your [ULHPC account](index.md) defines the UNIX **user** you can use to connect to the facility and make you known to our systems. They are managed by the [Identity Management (IdM) system](../connect/idm.md) and define your `login`.
