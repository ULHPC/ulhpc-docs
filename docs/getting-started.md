...
Led by Dr. [Varrette](https://varrette.gforge.uni.lu) for 15 years (until Aug 31, 2022), the [ULHPC team](https://hpc.uni.lu/about/team.html) (recently renamed "Digital Platform" and headed by Hyacinthe Cartiaux starting Spet 1st, 2022) manages several research computing facilities located on the [Belval campus](https://wwwen.uni.lu/contact/campus_de_belval), offering a **cutting-edge research infrastructure to Luxembourg public research** while serving as _edge_ access to bigger systems from PRACE or EuroHPC, such as the Euro-HPC Luxembourg supercomputer "[MeluXina](https://luxprovide.lu)".
