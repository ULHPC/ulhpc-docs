...
This page records a brief timeline of significant events and user environment changes on Iris. The **Iris** cluster exists since the beginning of 2017 as the flagship HPC supercomputer within the [University of Luxembourg](http://www.uni.lu) until 2020 and the release of the [Aion](../aion/index.md) supercomputer.
