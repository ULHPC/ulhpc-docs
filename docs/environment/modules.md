...
??? info "Tcl/C Environment Modules vs. Tcl [Environment Modules](https://modules.readthedocs.io/) vs. [Lmod](https://lmod.readthedocs.io/)"
    ...
    * (**recommended**) [Lmod](https://lmod.readthedocs.io/): a Lua based Environment Module system
    ...
    The ULHPC Facility relies on [Lmod](https://lmod.readthedocs.io/), the associated [Modulefiles](https://lmod.readthedocs.io/en/latest/015_writing_modules.html) are almost exclusivelly generated automatically by [Easybuild](https://docs.easybuild.io/).
