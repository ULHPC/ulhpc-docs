All ULHPC login accounts are associated with specific individuals and must **not** be shared. In some HPC centers, you may be able to request _Collaboration Accounts_ designed to handle the following use cases:
