...
#let sns-polylux-template_title-text-color      = state("title_color", none)//#000000
...
#let sns-polylux-template_side_image            = state("side_image",  none)
...
#let sns-polylux-template(
  ...
  // title-font   : ("PT Sans", "DejaVu Sans"),
  title-font   : ("Raleway", "PT Sans", "DejaVu Sans"),
  txt-color1   : black,
  txt-color2   : rgb("#222222"),
  ...
  sns-polylux-template_side_image.update(side_image)
...
side_image      : none,
  ...
  let content = align(top + center, context( {
    let title       = sns-polylux-template_title.at(here())
        ...
        let side_image  = {
          if side_image == none { sns-polylux-template_side_image.at(here()) }
        else                  { side_image }
      }
        ...
        grid(
          ...
          // Use box.inset to fix the blank border issue
          box(image(side_image, width: 100%, height: 100%, fit: "cover"), clip: true, inset: -1pt),

            
          // Right column - multiple place statements for title slide elements
              ...
              place(
                ...
                top + left,
                  polygon(
                    fill   : sns-polylux-template_colormap.at(here()).at(0),
                    stroke : none,
                    (0%, 0%),(0%, 15%),(100%, 15%),(100%, 0%),
                  ),
                  )
                  place(
                bottom + center,
                  dy: -1cm,
                  text(fill: sns-polylux-template_main-text-color.at(here()), size: 22pt, event)
                )
                  if logo != none {
                place(
                  bottom + right,
